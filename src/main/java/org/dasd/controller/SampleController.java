...
public class SampleController {
    ...
    public void sample4(Model model){
        ...
        for (int i = 0; i <10 ; i++) {
            ...
            list.add(new MemberVO(i,"u000"+i%3,"p000"+i%3,"wh"+i,new Timestamp(System.currentTimeMillis())));
        }
    ...
    public void sample6(Model model){
        ...
        for (int i = 0; i <10 ; i++) {
            list.add(new MemberVO(i,"u0"+i,"p0"+i,"name"+i,new Timestamp(System.currentTimeMillis())));
